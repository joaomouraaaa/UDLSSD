...
## Segmentation data
In this work, 7000 images from the SAR-Ship-Dataset were manually segmented to train the supervised models. 
...
We also provide some of the data used in our experiments.
