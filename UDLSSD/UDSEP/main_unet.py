...
from unet_model_256 import *
from data2_256 import *
...
directory='data_transformed/images'
...
import json
with open('unet_partition.json', 'w+') as json_file:
...
model.save_weights('results/01')
np.save('models/history_model_01.npy',history.history)
